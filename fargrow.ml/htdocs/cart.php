    ...
    <form method="post" enctype="multipart/form-data" >
      <!--<div class="row">
          ...
          <button type="submit" value="Upload" name="insert" id="insert" data-loading-text="Loading..." class="btn btn-primary" >-->
           ...
           <a href="http://farmers.fargrow.ml/"> <input type="button" value="Sell Your Products" name="myproduct" id="myproduct" data-loading-text="Loading..." class="btn btn-primary" ></a>
