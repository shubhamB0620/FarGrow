...
session_start();
	...
	if (isset($_POST['reg_user'])) {
		...
		if (count($errors) == 0) {
			...
			$query = "INSERT INTO users(Fname,Lname,MobNo,email,Addr1,Addr2,zone_id,postcode,country_id,zone_id_2,password) 
	...
	if (isset($_POST['login_user'])) {
		...
		if (count($errors) == 0) {
			...
			$query = "SELECT * FROM users WHERE MobNo='$MobNo' AND password='$password'";
...
//Update User Details
    if (isset($_POST['update'])) {
            ...
            if (count($errors) == 0) {
                ...
                $up_query = "UPDATE users SET Fname='$Fname', Lname='$Lname', email='$email', Addr1='$Addr1', Addr2='$Addr2',zone_id='$zone_id', postcode='$postcode', country_id='$country_id', zone_id_2='$zone_id_2' WHERE MobNo = '$MobNo'";
