    ...
    <div class="navbar-collapse">
      <ul class="main-navigation">
       ...
       <!--<li><a href="category.php"   class="parent"  >Product</a> </li>-->
        ...
        <li><a href="http://farmers.fargrow.ml/" class="parent"> Sell My Product</a>
      ...
      <form class="form-horizontal" enctype="multipart/form-data" method="post" action="register.php">
        ...
        <div class="buttons">
          <!--<div class="pull-right">I have read and agree to the <a class="agree" href="#"><b>Privacy Policy</b></a>
            ...
            &nbsp;
            <div class="g-recaptcha" data-sitekey="6Lc2r_0UAAAAAF8oYpUPBPLOtEBzg6IzRFpJT956"></div>
            <br>
...
function CheckCaptcha($userResponse) {
        $fields_string = '';
        $fields = array(
            'secret' => '6Lc2r_0UAAAAAK0VyR3fXZFdv5nCGGbKTSVrJXBh',
    ...
    <div class="row">
      <div class="col-sm-3 footer-block">
        ...
        <ul class="list-unstyled ul-wrapper">
          ...
          <li><a href="http://fargrow.ml/about-us.php">About Us</a></li>
      ...
      <div class="col-sm-3 footer-block">
        ...
        <ul class="list-unstyled ul-wrapper">
          <li><a href="http://fargrow.ml/contact.php">Contact Us</a></li>
          <li><a href="profile.php">My Account</a></li>
  ...
  <div class="footer-bottom">
    <div id="bottom-footer">
      <ul class="footer-link">
        <li><a href="http://fargrow.ml/index.php">Home</a></li>
        <li><a href="http://fargrow.ml/category.php">Product</a></li>
        <li><a href="http://farmers.fargrow.ml/">Sell My Product</a></li>
        <li><a href="http://fargrow.ml/about-us.php">About Us</a></li>
        <li><a href="http://fargrow.ml/contact.php">Contact Us</a></li>
      </ul>
